...
console.log('[Season Color Checker] ColorThief available:', ...);
console.log('[Season Color Checker] Settings loaded:', settings);
console.log('[Season Color Checker] Found X product images to analyze');
```
...
[Season Color Checker] Found X product images to analyze
```
